...
relational_expr:
        unary_expr (relational_operator unary_expr)*
;
...
scalar:
    ...
    |   common_scalar
    |   '"' encaps_list '"'
    // This is very odd, its an artefact of how the php scanner worked
    |   '\'' encaps_list '\''
...
expr:
        r_cvar
    |   expr_without_variable { printf("An Expression Happened\n"); }
;
*/
